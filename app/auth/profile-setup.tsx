...
const ProfileSetup = () => {
  ...
  const themeColors = {
    ...
    success: '#10b981',
    warning: '#f59e0b',
    adminBackground: activeTheme === 'light' ? 'rgba(232, 92, 41, 0.1)' : 'rgba(232, 92, 41, 0.2)',
    adminBorder: activeTheme === 'light' ? '#e85c29' : '#e85c29',
    adminText: activeTheme === 'light' ? '#e85c29' : '#e85c29',
    adminIcon: activeTheme === 'light' ? '#e85c29' : '#e85c29',
